...
<main class="max-w-sm mx-auto px-4 py-6">
	<h1 class="text-2xl font-bold mb-4 text-center text-gray-800">Créer un compte</h1>
	...
	<div class="mx-auto rounded-sm ring-1 ring-black/5 bg-white shadow p-4">
		<form onsubmit={(e) => { e.preventDefault(); handleRegister(); }} class="flex flex-col gap-4">
			...
			>
				{#if showPassword}
					<!-- eye-off icon -->
					<svg viewBox="0 0 28 28" class="h-6 w-6" fill="none" xmlns="http://www.w3.org/2000/svg">
