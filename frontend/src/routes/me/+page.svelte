<script lang="ts">
    ...
    let active: 'stats' | 'achievements' | 'account' | 'options' = $state('stats');
        ...
        <div class="w-full max-w-xl mx-auto">
            <div class="w-full rounded-full bg-white ring-1 ring-black/5 p-1 shadow-sm">
                <div class="grid grid-cols-4 gap-1">
                    <button
                        class="w-full text-center px-2 py-1.5 text-xs rounded-full transition cursor-pointer {active==='stats' ? 'bg-emerald-600 text-white shadow font-bold' : 'text-gray-700 hover:bg-gray-50'}"
                    ...
                    <button
                        class="w-full text-center px-2 py-1.5 text-xs rounded-full transition cursor-pointer {active==='achievements' ? 'bg-emerald-600 text-white shadow font-bold' : 'text-gray-700 hover:bg-gray-50'}"
                    ...
                    <button
                        class="w-full text-center px-2 py-1.5 text-xs rounded-full transition cursor-pointer {active==='account' ? 'bg-emerald-600 text-white shadow font-bold' : 'text-gray-700 hover:bg-gray-50'}"
                    ...
                    <button
                        class="w-full text-center px-2 py-1.5 text-xs rounded-full transition cursor-pointer {active==='options' ? 'bg-emerald-600 text-white shadow font-bold' : 'text-gray-700 hover:bg-gray-50'}"
