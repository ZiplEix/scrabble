			...
			>
				{#if showPassword}
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
						...
						<path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10a9.96 9.96 0 012.277-6.176m1.59-1.594A9.956 9.956 0 0112 3c5.523 0 10 4.477 10 10 0 2.042-.602 3.94-1.64 5.52M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
