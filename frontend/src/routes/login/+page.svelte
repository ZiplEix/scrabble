...
<main class="max-w-sm mx-auto px-4 py-8">
	<div class="text-center mb-8">
		<div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-brand-emerald-light text-brand-emerald shadow-sm mb-3 text-2xl font-bold select-none">
			🔑
		</div>
		<h1 class="text-2xl font-extrabold text-stone-800 tracking-tight">Ravi de vous revoir !</h1>
		<p class="text-stone-500 text-xs mt-1">Connectez-vous pour rejoindre vos parties en cours</p>
	</div>
	...
	<p class="mt-8 text-sm text-center text-stone-500">
		...
		<a href="/register" class="text-brand-emerald font-bold hover:underline">Créer un compte</a>
	</p>
</main>
